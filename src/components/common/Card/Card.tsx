  ...
  return (
    <div className={clsx("flex flex-col rounded-xl bg-[--blue1] m-1 mb-3 rounded-t-2xl shadow-gray-600 shadow-lg", className)}>
      <div className="flex flex-col relative">
        <Image src={image} alt={title} loading="lazy" className="w-full rounded-t-2xl" width={400} height={240} />
      ...
      <div className="p-3 text-[--gray3]">
        <span className="text-3xl font-bold mb-2 inline-block">{title}</span>
        <p className="min-h-36 mb-7 text-2xl">
          {text}
        </p>
        <Button variant="transparent" className={clsx("flex place-self-end border rounded-b-lg text-[--gray3] border-[--gray3]", "hover:text-[--gray3]")} href={url}>Ver más</Button>
      </div>
